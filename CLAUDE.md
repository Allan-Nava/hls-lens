...
- **Gate prima di chiudere**: `npm run typecheck` + `npm test` + `npm run docs` (deve essere un no-op) verdi. Stessi check della CI.
...
- **Todo → `BACKLOG.md`** (sorgente unica, id stabili `HL-n`). Non sparpagliare TODO nei commenti.
...
- Backlog: `BACKLOG.md` · CI: `.github/workflows/ci.yml` · Riferimento regole generato: `docs/RULES.md`
